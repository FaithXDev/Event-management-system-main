  ...
  return (
    <div className="space-y-6">
      ...
      {announcements.length > 0 && (
        <div className="rounded-xl p-3 bg-orange-50 dark:bg-orange-900/30 border border-orange-200 dark:border-orange-800">
          <div className="font-semibold mb-1">Live announcements</div>
          <ul className="text-sm text-orange-800 dark:text-orange-200 list-disc pl-5 space-y-1">
    ...
    <ul className="space-y-2">
      {rows.map((r, idx) => (
        <li key={r._id || idx} className="flex items-center justify-between p-2 rounded-lg bg-slate-50 dark:bg-slate-800">
          ...
          <span className="text-orange-700 dark:text-orange-300 font-semibold">{r.points} pts</span>
        </li>
      ))}
    </ul>
  );
